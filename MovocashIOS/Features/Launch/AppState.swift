...
enum AuthFlow: String {
    case splash, choice, waitlist, loginPhone, getStartedPhone, otp, signupDetails, emailVerification, setPassword, getStartedInfo, enableBiometrics, pickDocument, kyc, kycSuccess, appLock, warmRelock, home
}
